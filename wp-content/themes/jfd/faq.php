            ...
            <div class="row fluid ">
                ...
                <aside class="col-md-4 faq-sidebar">
                    <div class="list-group">
                        ...
                        <button type="button" data-toggle="collapse" href="#price-questions" class="faq-list-item list-group-item list-group-item-action">
                           <span class="fa fa-angle-right"></span> Prices
                        </button>
                        ...
                        <button type="button" data-toggle="collapse" href="#deal-questions" class="faq-list-item list-group-item list-group-item-action">
                           <span class="fa fa-angle-right"></span>  Deals
                        </button>
                ...
                <main id="main" class="site-main col-md-8" role="main">
                    ...
                    <section class="section section-2 prices">
                        ...
                        <p>
                            For a simple website that will have about 5 pages developed I have a flate rate of $500. This job will include
                        </p>

                        <ul class="bold">
                            <li>Web design mockup of how the website will be constructed</li>
                            <li>Creating the website with HTML/CSS</li>
                            <li>Designing it to respond in mobile devices</li>
                            <li>Adding dynamic functionality with javascript</li>
                            <li>Simple data storage and retrieval</li>
                            <li>SEO optimization</li>
                        </ul>

                        <h5 class="und">Additional Pages</h5>

                        <p>
                            For websites that will be more than 5 pages, we charge an additional $250 for every 5 page increment. So that means if you want a 10 page or a 6 page website the flat fee will be $750. If you want a 15 page website it will be $1000 and so forth
                        </p>
                        ...
                        <p>
                            For 5 pages to be updated will be dependent upon the type of things you want update or add.

                        </p>

                        <ul class="bold">
                            <li>HTML, CSS, and or Images: $250</li>
                            <li>HTML, CSS, JS, and or Images: $300</li>
                            <li>Everything: $400</li>
                        </ul>
